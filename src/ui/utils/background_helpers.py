"""Background task utilities consolidating task management and refresh utilities.

This consolidated module combines background task management and throttled refresh
utilities for optimal organization and reduced file count.

Consolidates:
- background_tasks.py: Streamlined background task management using Streamlit built-ins
- refresh.py: Utilities for safe, throttled Streamlit reruns
"""
...
from src.ui.utils.ui_helpers import safe_job_count
...
# ===============================================================================
# REFRESH UTILITIES (from refresh.py)
# ===============================================================================
...
# ===============================================================================
# BACKGROUND TASK MANAGEMENT (from background_tasks.py)
# ===============================================================================
...
def start_scraping() -> None:
    """Start the scraping process with trigger-based approach."""
    ...
    print(
        f"DEBUG: start_scraping called from "
