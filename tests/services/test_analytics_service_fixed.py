"""Comprehensive tests for the DuckDB sqlite_scanner AnalyticsService.
...
class TestAnalyticsServiceIntegration:
    ...
    def test_performance_characteristics(self, analytics_service):
        ...
        assert trends["status"] == "success"
        assert trends_time < 2.0  # Should complete under 2 seconds
        ...
        assert companies["status"] == "success"
        assert company_time < 2.0  # Should complete under 2 seconds
