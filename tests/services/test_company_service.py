...
def sample_jobs(test_session, sample_companies):
    ...
    jobs = [
        ...
        JobSQL(
            ...
            link="https://techcorp.com/jobs/python-1",
        ...
        JobSQL(
            ...
            link="https://techcorp.com/jobs/ml-1",
...
class TestCompanyServiceRetrieval:
    ...
    def test_get_companies_with_job_counts(
        ...
        # TechCorp should have 3 total jobs (2 active + 1 archived), 2 active
        assert techcorp_stats["total_jobs"] == 3
...
class TestCompanyServiceCreation:
    ...
    def test_add_company_duplicate_name_error(self, mock_db_session, sample_companies):
        ...
        with pytest.raises(ValueError, match="Company 'TechCorp' already exists"):
